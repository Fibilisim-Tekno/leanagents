...
| Antigravity | .agents/rules/leanagents.md | Set in Rules UI or explicitly mention | Plain rule export only; activation not automated |
...
Current startup text counts: Codex/Antigravity 168; Kiro/Cursor 175. These are
...
- [Antigravity rules](https://antigravity.google/docs/rules-workflows).
  ...
  supported. The public page does not specify serialized activation metadata,
  so the exporter does not invent it.
